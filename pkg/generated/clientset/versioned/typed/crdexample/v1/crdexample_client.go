...
// CrdexampleV1Client is used to interact with features provided by the crdexample.tlm.dev group.
type CrdexampleV1Client struct {
	restClient rest.Interface
}

func (c *CrdexampleV1Client) Tweets(namespace string) TweetInterface {
	return newTweets(c, namespace)
}
